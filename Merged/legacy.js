...
// Create Menu
  ...
  function createMenu(cf, as, sp) {
    ...
    */
    ...
    form.prepend(menu);
    createCommentfacefield(commentFaces, form);
  }
...
function createCommentfacefield(commentFaces, form) {
  const innerform = $(form).children('.ranimeenhanced').children('.commentfaces');

  initializeTabs(commentFaces, innerform);
...
function initializeTabs(commentFaces, innerform) {
  ...
  showcommentfacestab.click(() => {
    if (showcommentfacestab.siblings('.commenttabwrapper').css('display') === 'none') {
      ...
      createCommentfaces(commentFaces, innerform);
    } else {
...
function createCommentfaces(commentFaces, innerform) {
